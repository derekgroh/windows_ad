...
* Issue 121 - <https://github.com/sous-chefs/windows_ad/issues/121> allow use of spaces in Distinguished Name.
...
* Issue 100 - <https://github.com/sous-chefs/windows_ad/issues/100> initial support for Windows 2016.
* Quality changes - chefignore, default recipe uses float to compare os_version.

## 0.5.3

* Issue 87 - <https://github.com/sous-chefs/windows_ad/issues/87> revert Robocop edits on providers

## 0.5.2

* Issue 85 - <https://github.com/sous-chefs/windows_ad/issues/85> revert Robocop edits on dsquery
...
* Join and unjoin actions from domain provider moved to computer provider - <https://github.com/sous-chefs/windows_ad/pull/77>
* Correct user action to address dsmod error - <https://github.com/sous-chefs/windows_ad/issues/71>
* Fixed bug in join ou that always reported that the resource was updated
* Gitter badger added - <https://github.com/sous-chefs/windows_ad/pull/66>
* Proper formattign for pre-win2012 systems - <https://github.com/sous-chefs/windows_ad/pull/70> and <https://github.com/sous-chefs/windows_ad/pull/74>

## 0.4.5

* Rubocop and foodcritic - <https://github.com/sous-chefs/windows_ad/issues/2>
* Add success return codes for installing DC. - <https://github.com/sous-chefs/windows_ad/issues/1>
